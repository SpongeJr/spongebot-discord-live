module.exports = {
	...
	SCRAMWORDS_NOKHAN: require('../../data/scramwordsnokhan.json'),
	...
	SLOTS_SYMBOL_FILENAME: '../data/slotsymbols.json',
		...
		"weeklyCollect": {
			...
			"bonus": {
				"role": {
					...
					"KA": {
						bonusAmt: 3000,
						id: "818456801947287573"
					},
					"Ourscraft": {
						bonusAmt: 3000,
						id: "783507327068274688"
					},
					"Server Booster": {
						bonusAmt: 12500,
						id: "662426665565290515"
					},
					"Concerts": {
						bonusAmt: 3000,
						id: "851143251737051196"
					}
				}
			}
		}
